            ...
            <div className="space-y-12">
              <SectionCard title="Trending">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  <ProductCard name="Wireless Earbuds" price="2,500 points" />
                  <ProductCard name="SmartFin Hoodie" price="1,800 points" />
                  <ProductCard name="Power Bank" price="1,200 points" />
                </div>
              </SectionCard>

              <SectionCard title="New">
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  <ProductCard name="Notebook Set" price="800 points" />
                  <ProductCard name="Water Bottle" price="950 points" />
                  <ProductCard name="Laptop Sleeve" price="1,500 points" />
                </div>
              </SectionCard>
